    ...
    <form autocomplete="off" action="saveData.php" method="POST" id="form" >
        <main class="form_main__container" id="form_main__container">
            <section class="form__container" id="form__container">
                ...
                <label for="button">
                    <button type="button" class="button__start" id="button__start">¡COMENZAR!</button>
                </label>
            </section>
        </main>
            ...
            <section class="answers__container">
                ...
                <section class="answer_card__container" id="first__answer">
                    <section class="card__content">
                        ...
                        <img class="blue__button" src="" alt="Respuesta" id="first_question__icon">
                ...
                <section class="answer_card__container" id="second__answer">
                    <section class="card__content">
                        ...
                        <img class="blue__button"src="" alt="Respuesta" id="second_question__icon">
                ...
                <section class="answer_card__container" id="third__answer">
                    <section class="card__content">
                        ...
                        <img class="blue__button" src="" alt="Respuesta" id="third_question__icon">
                        <h2 class="card_second__title">VERDADERO</h2>
